...
public class ZMUTread extends JFrame implements Runnable, ThreadFactory, ActionListener {
	...
	public void run() {
		...
		String filename = "EMPTY FILE created by error in ZMUTread.csv";
		String filename2 = "EMPTY FILE created by error in ZMUTread.txt";
	...
	public static void main(String[] args) {
		new ZMUTread(0);	// Change the starting webcam from here (0 is the default webcam)
	}
